	<?php if(empty($arrData)) 
		...
		<div class="main">
						...
						?>
								<tr>
									<td><a href="<?php echo SITE_PATH?>index.php?controller=admin&function=fncAddUser&email=<?php if(isset($value['email_address'])){
												echo $value['email_address'] ;
						} 
						?> "><input type="button" value="Authorize User"/></a></td>
